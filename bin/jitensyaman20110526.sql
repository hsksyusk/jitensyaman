...
DROP INDEX TWITTER_USER_ID ON JITENSYAMANUSER;
DROP INDEX TWITTER_USER ON JITENSYAMANUSER;
...
ALTER TABLE JITENSYAMANTRACKS
	...
	REFERENCES JITENSYAMANUSER (ID_FIELD)
	ON UPDATE RESTRICT
	ON DELETE RESTRICT
;
...
CREATE UNIQUE INDEX TWITTER_USER_ID ON JITENSYAMANUSER (TWITTER_USER_ID ASC);
CREATE INDEX TWITTER_USER ON JITENSYAMANUSER (TWITTER_USER ASC);
