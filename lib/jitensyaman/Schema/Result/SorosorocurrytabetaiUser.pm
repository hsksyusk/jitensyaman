package jitensyaman::Schema::Result::SorosorocurrytabetaiUser;
...
jitensyaman::Schema::Result::SorosorocurrytabetaiUser
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:ID3XU6V/pzipLartLsrY6Q
